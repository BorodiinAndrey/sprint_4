...
class TestBooksCollector:
    ...
    params = [
            ...
            ([''], 0),
            (['Очень длинное название книги, 42 символа!!'], 0),
            (['Очень длинное название книги, 40 символа'], 1),
            (['Очень длинное название книги, 41 символ!'], 1)
        ]

    @pytest.mark.parametrize('book_name, expected_count', params)
    def test_add_new_book_limits(self, book_name, expected_count):
